...
"""
    Basemaps to QGIS Browser.
    Alternative to the QuickMapServices plugin, based on Klas Karlsson script.
"""
...
class BasemapsLoader:
    """Module to manage basemaps sources from a remote file."""
    ...
    def action(self):
        self.log(
            message="Let's add some basemaps to QGIS Browser",
            log_level=4,
        )

    def get_basemaps(self, options):
        ...
        sources.append(
            [
                ...
                "http://tile.openweathermap.org/map/temp_new/%7Bz%7D/%7Bx%7D/%7By%7D.png?APPID=1c3e4ef8e25596946ee1f3846b53218a",
                "",
                "19",
                "0",
            ]
        ...
        sources.append(
            [
                ...
                "",
                "Map tiles by OpenWeatherMap, under CC BY-SA 4.0",
                "http://tile.openweathermap.org/map/clouds_new/%7Bz%7D/%7Bx%7D/%7By%7D.png?APPID=ef3c5137f6c31db50c4c6f1ce4e7e9dd",
                "",
                "19",
                "0",
            ]
        ...
        sources.append(
            [
                ...
                "",
                "Map tiles by OpenWeatherMap, under CC BY-SA 4.0",
                "http://tile.openweathermap.org/map/wind_new/%7Bz%7D/%7Bx%7D/%7By%7D.png?APPID=f9d0069aa69438d52276ae25c1ee9893",
                "",
                "19",
                "0",
            ]
